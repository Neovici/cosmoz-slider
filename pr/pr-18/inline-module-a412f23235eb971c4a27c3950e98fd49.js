...
const importers = {
  "./stories/cosmoz-slider.stories.js": () => import('./cosmoz-slider.stories-CeL1O_d0.js')
};
...
const getProjectAnnotations = async () => {
  const configs = await Promise.all([
    import('./entry-preview-izj0ky5T.js'),
    import('./entry-preview-docs-C1G5qCCo.js'),
    import('./preview-D6eFHMW8.js'),
